        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < sequence.Length; i++)
                {
                    ...
                    if (currentSequenceSize > bestSequeceSize)
                    {
                        bestSequeceSize = currentSequenceSize;
                    ...
                    else if (currentSequenceSize == bestSequeceSize)
                    {
